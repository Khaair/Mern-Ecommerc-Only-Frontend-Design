    ...
    <>
      <div className='navcontainer'>
        <ul className='navv'>
          ...
          <li> <Link className='responseright' to="/addtocart"><img style={{ height: '40px' }} src='img/addtocart.png' alt='kii' /></Link> </li>
          <li> <Link className='responserightmar' to="/wishlist"><img style={{ height: '40px' }} src='img/wishlistt.png' alt='kii' /></Link> </li>
